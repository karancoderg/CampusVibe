...
const CreatePost = ({ defaultCommunity, onPostCreated }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const newPost = {
      ...
      avatar: selectedType.name === 'Anonymous' ? getPlaceholderUrl(40, 40) : profile.avatar_url,
    ...
    try {
      ...
      if (error) {
        ...
        const realPostUpdates = {
          ...
          avatar: data.is_anonymous ? getPlaceholderUrl(40, 40) : data.profiles?.avatar_url,
